<template>
    <div class="container">
        <div class="logo-img">
            <img class="amazon-logo" src="amazonLogo.png.jpeg" alt="amazon logo">
        </div>
        ...
        <div class="delivery-location-container">
            ...
            <div class="name-address">
                <span class="delivery-name">Hello</span>
                <span class="delivery-address"> Select Your Address</span>
            </div>
        </div>
        ...
        <div class="nav-right">
			<div id="nav-tools">
				...
				<div class="delivery-location-container">
                    <div class="name-address">
                        <span class="delivery-name">Returns</span>
                        <span class="delivery-address">& Orders</span>
                    </div>
                </div>
...
<style scoped>
    ...
    #nav-search-bar-form .nav-left > a,  #nav-search-bar-form .nav-left > i{
        color: #686868;
    }
    #nav-search-bar-form .nav-left {
        border-radius: 5px 0 0 5px;
    }
    #nav-search-bar-form .nav-left:hover > a  {
        color: #131921;
    }
    #nav-search-bar-form .nav-left > i:hover {
        color: black;
    }
    #nav-search-bar-form .nav-left:hover {
        background: #D0D0D0;
    }
    ...
    #nav-search-bar-form .nav-right > i {
        display: flex;
        flex: 1 1 auto;
        align-items: center;
